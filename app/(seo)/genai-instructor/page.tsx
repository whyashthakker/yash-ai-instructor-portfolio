...
export const metadata: Metadata = {
  ...
  description: 'Master Generative AI with expert instruction from Yash Thakker. Learn ChatGPT, GPT-4, Claude, and LLM applications. 350K+ students trained worldwide.',
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join 350,000+ students who have mastered Generative AI with our comprehensive training programs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://www.udemy.com/user/feelix-2" target="_blank" rel="noopener noreferrer"
