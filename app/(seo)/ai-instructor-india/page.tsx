...
export const metadata: Metadata = {
  ...
  description: 'Leading AI instructor in India. Expert AI training from Mumbai-based Yash Thakker. 350K+ students trained in Artificial Intelligence across India.',
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Leading AI education from Mumbai to the world - Trusted by 350,000+ students across India and globally
          </p>
