      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Transform your career in 4 weeks with hands-on AI training. Build real projects, master AI tools, and join 350K+ successful students.
          </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Learn from Yash Thakker - 12+ years building AI products, 350K+ students taught, Fortune 500 experience.</p>
                </div>
              </div>
            </div>
          </div>
