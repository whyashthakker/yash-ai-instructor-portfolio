...
export const metadata: Metadata = {
  ...
  description: 'Best online AI courses by Yash Thakker. Learn AI, Machine Learning, ChatGPT, and automation. 50+ courses, 350K+ students, lifetime access.',
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8">
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur">
                ...
                <p className="text-sm">Learn from Yash Thakker - 12+ years experience, 350K+ students taught</p>
              </div>
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur">
                <div className="text-3xl mb-3">⏰</div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join 350,000+ students learning AI online. Get lifetime access, learn at your pace, and transform your career.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://www.udemy.com/user/feelix-2" target="_blank" rel="noopener noreferrer"
