...
export const metadata: Metadata = {
  ...
  description: 'Learn AI from industry expert Yash Thakker. 350K+ students trained in Generative AI, Machine Learning, and AI applications. Join our comprehensive AI courses.',
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Transform your career with expert AI training from Yash Thakker - trusted by 350,000+ students worldwide
          </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">350,000+ students successfully trained across multiple platforms with 350,000+ students on Udemy alone.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#d97757] mb-2">350K+</div>
